...
```
Same steps where performed with filtering for C-section
...
```
Same steps where performed with filtering for Vaginal
...
# Results
## Family level abundance
Calculating the relative abundance at family level. Families with mean ≤ 2% where merged into 'Other'
...
Calculating the relative abundance at Bifidobacterium species level. Species with mean ≤ 2% where merged into 'Other'
